...
$(document).ready(function(){
    ...
    checker.click(function(){
        if ($(this).attr('id')==='slide1') {
            ...
            mainPageImage.css('background-image','url(static/images/content/1.png)');
        ...
        if ($(this).attr('id')==='slide2'){
            ...
            mainPageImage.css('background-image','url(static/images/content/2.png)');
            mainPageTextIceCream.text('Шоколадный пломбир и лимонный сорбет')
        } else {
            mainPageColor.css('background-color','#9d8b84');
            mainPageImage.css('background-image','url(static/images/content/3.png)');
